...
urlpatterns = [
    ...
    url(r'add_storedata$', views.add_storedata),
    ...
    url(r'update_storedata$', views.update_storedata),
    ...
    url(r'show_sale_paths$', views.show_sale_paths),
    url(r'show_supply_paths$', views.show_supply_paths),
    url(r'show_components$', views.show_components),
    url(r'show_employees$', views.show_employees),
]
