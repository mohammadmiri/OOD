    ...
    <%--<div class="container well-lg">--%>
        <%--<div class="row">--%>
            <%--<div class="col-md-offset-3 col-md-6 bg-info main-container img-rounded">--%>
                <%--<form action="path/submit/update_sale_path" class="form-group-sm">--%>
                    <%--<div class="row">--%>
                        <%--<div class="col-md-3">--%>
...
<div class="panel panel-default text-bold margin-large-top">
    <div class="panel-heading text-center">update sale chain</div>
    <div class="panel-body padding-large-top">
        <form action="/path/submit/update_sale_path/${chain.id}" method="get">
